...
public static class Paths
{
  ...
  public const StringComparison FileSystemPathComparison = StringComparison.OrdinalIgnoreCase;
  ...
  /// <summary>
  /// Compares the two file paths using <see cref="FileSystemPathComparison"/>.
  /// </summary>
  public static bool FilePathsAreEqual(string path1!!, string path2!!) => string.Equals(path1, path2, FileSystemPathComparison);
  ...
  /// Comparison is made using <see cref="FileSystemPathComparison"/>
  /// </summary>
  public static bool DirectoryPathsMatch(string path1!!, string path2!!)
  {
    return path1.Length == 0 && path2.Length == 0
      || string.Equals(NormalizeDirectoryPath(path1), NormalizeDirectoryPath(path2), FileSystemPathComparison);
  }
}
